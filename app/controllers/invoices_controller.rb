...
def emitir_factura(oc_number)
  ...
  def crear_boleta(cliente = nil,proveedor = nil, total = nil)
    cliente   = cliente || params.require(:cliente) 
    proveedor = proveedor || params.require(:proveedor) 
    total     = total || params.require(:total)
